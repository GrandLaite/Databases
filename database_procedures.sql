...
Создайте процедуры, выполняющие указанные ниже действия к базе данных, разработанной в лабораторной работе №1.

Вариант №1
1. Процедура автоматического обновления цен на товары в базе данных, основанная на данных от поставщиков и изменениях на рынке.
2. Процедура автоматического формирования заказов на основе данных о запасах товаров и прогнозах продаж.
*/
